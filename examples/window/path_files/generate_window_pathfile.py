...
obsd_asdfbase = "/lustre/atlas/proj-shared/geo111/Wenjie/DATA_EBRU/proc/obsd"
synt_asdfbase = "/lustre/atlas/proj-shared/geo111/youyir/DATA_EBRU/proc_synt"
window_base = "/lustre/atlas/proj-shared/geo111/Wenjie/DATA_EBRU/window"
...
period_list = ["17_38", "30_56", "92_250"]
...
def generate_json_dirfiles(eventname):
    ...
    for period in period_list:
        ...
        par_jsonfile = os.path.join(output_json_dir, "%s.%s.path.json"
                                    % (event, period))
